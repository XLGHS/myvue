...
export default {
  ...
  methods: {
    ...
    savePoster() {
      ...
      //在canvas context中也存在一个webkitBackingStorePixelRatio的属性（仅safari和chrome），该属性的值决定了浏览器在渲染canvas之前会用几个像素来来存储画布信息。
      ...
      img2.onload = function () {
        ctx.drawImage(img2, 125, W + 160, W / 3, W / 3);
      };
